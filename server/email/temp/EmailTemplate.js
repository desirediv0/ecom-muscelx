...
<head>
    ...
    <title>Verify Your Email - MuscelX</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Welcome to MuscelX</h1>
        </div>
        <div class="content">
            <h2>Verify Your Email</h2>
            <p>Dear Valued Customer,</p>
            <p>Welcome to MuscelX - your trusted source for premium quality supplements. Please verify your email address to access your account:</p>
            ...
            <p>If you didn't create an account with MuscelX, please disregard this email.</p>
        ...
        <div class="footer">
            © ${new Date().getFullYear()} MuscelX | Premium Health Supplements<br>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Password - MuscelX</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear Valued Customer,</p>
            <p>We received a request to reset the password for your MuscelX account. Click the button below to create a new password:</p>
            <a href="${resetLink}" class="button">Reset Password</a>
            <p>If you didn't request this password reset, please contact our support team immediately at support@MuscelX</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Confirmation - MuscelX</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
  ...
  data.shippingAddress.state
        ...
        <div class="footer">
            © ${new Date().getFullYear()} MuscelX | Premium Health Supplements<br>
            Questions? Contact our customer support at support@MuscelX
        </div>
    </div>
</body>
</html>
