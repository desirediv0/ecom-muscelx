...
const ProductCard = ({ product, onQuickView }) => {
    ...
    return (
        <div
            ...
            className="bg-white border border-gray-200 hover:border-[#ed1c24] transition-all duration-300 group rounded-lg p-6 h-full shadow-sm hover:shadow-lg"
        >
            <div className="relative mb-4">
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2">
                    <Button
                        variant="ghost"
                        size="sm"
                        className={`w-8 h-8 p-0 bg-white hover:bg-[#ed1c24] ${isInWishlist ? 'text-[#ed1c24]' : 'text-gray-600'} hover:text-white rounded-full shadow-sm`}
                    ...
                    <CarouselContent>
                        {products.map((product, index) => (
                            <CarouselItem
                                ...
                                className="basis-full sm:basis-1/2 lg:basis-1/4 xl:basis-1/5 pl-4"
                            >
                                <ProductCard
                                    product={product}
