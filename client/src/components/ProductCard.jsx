...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      key={product.id}
      className="bg-white overflow-hidden transition-all hover:shadow-lg shadow-md rounded-xl group h-full border border-red-300 hover:border-red-400"
    >
            ...
            <>
              ...
              <div className="absolute top-3 right-3 z-10 flex flex-col gap-2">
                <Button
                  variant="ghost"
                  size="sm"
                  className="bg-white/90 hover:bg-primary/80 text-gray-700 hover:text-white rounded-full p-2 shadow-md"
                  onClick={(e) => {
                    e.preventDefault();
      ...
      <div className="p-3 md:p-4 text-center">
        ...
        <Link href={`/products/${product.slug}`} className="hover:text-primary">
          <h3 className="font-medium uppercase mb-2 line-clamp-2 text-xs md:text-sm text-primary">
            {product.name}
          </h3>
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="w-full p-2 mt-1 bg-primary"
