      ...
      <main className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative max-w-lg mx-auto mb-8">
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full pl-12 pr-4 py-3 h-12 rounded-xl border-2 border-gray-200 focus:border-red-500 focus:ring-red-500 transition-colors"
                />
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <Accordion type="single" collapsible className="w-full">
                  {filteredFaqs.map((faq, index) => (
                    ...
                    >
                      <AccordionTrigger className="text-lg font-semibold py-6 px-6 hover:no-underline hover:bg-red-50 transition-colors text-left">
                        <span className="flex items-start">
                          <span className="bg-red-100 text-red-600 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-0.5 flex-shrink-0">
                            {index + 1}
                          </span>
                          {faq.question}
                        </span>
            ...
            {/* Contact section */}
            <div className="mt-12 bg-gradient-to-r from-red-500 to-red-600 p-8 rounded-2xl text-center text-white shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="/contact">
                  <Button className="bg-white text-red-600 hover:bg-gray-100 px-8 py-3 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105">
