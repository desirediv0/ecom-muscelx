        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center bg-red-100 px-6 py-3 rounded-full">
            ...
            <span className="text-red-700 font-semibold">
              Category: <span className="text-red-600">{categorySlug}</span>
            </span>
          </div>
        </div>
      )}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link href={`/blog/${post.slug}`}>
                    <h2 className="text-xl font-bold mb-3 hover:text-red-600 transition-colors line-clamp-2 text-gray-800">
                      {post.title}
                    </h2>
                  </Link>
            ...
            <div className="flex justify-center mt-12">
              <div className="flex space-x-2">
                <Button
                  ...
                  disabled={page === 1}
                  className="px-6 py-2 border-2 border-red-200 text-red-600 hover:bg-red-50 rounded-xl"
                >
                  Previous
                </Button>
        ...
        <div className="text-center py-12 bg-white rounded-2xl shadow-lg border border-gray-100">
          ...
          {categorySlug && (
            <Button
              ...
              className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-8 py-3 rounded-xl font-semibold"
            >
              View All Posts
            </Button>
          )}
