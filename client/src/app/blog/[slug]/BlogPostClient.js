      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
        <div className="container mx-auto px-4 py-20 text-center">
          <div className="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <Link href="/blog">
              <Button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-6 py-3 rounded-xl font-semibold">
      ...
      <main className="pt-12 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center text-red-600 hover:text-red-700 mb-8 font-medium transition-colors group"
            >
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6 text-sm">
                ...
                {postData.categories?.map((category) => (
                  <Link
                    ...
                    className="flex items-center bg-red-100 text-red-600 px-3 py-1 rounded-full hover:bg-red-200 transition-colors"
                  >
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 mb-16">
              <div
                className="prose prose-lg max-w-none prose-headings:text-gray-800 prose-p:text-gray-600 prose-a:text-red-600 prose-strong:text-gray-800"
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <Link href={`/blog/${relatedPost.slug}`}>
                          <h3 className="font-bold hover:text-red-600 transition-colors line-clamp-2 mb-2 text-gray-800">
                            {relatedPost.title}
                          </h3>
                        </Link>
                        ...
                        <Link href={`/blog/${relatedPost.slug}`}>
                          <Button
                            variant="link"
                            className="px-0 text-red-600 text-sm font-semibold hover:text-red-700"
                          >
                            Read More
                          </Button>
                        </Link>
