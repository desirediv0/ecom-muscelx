      ...
      <ClientOnly>
        <div className="container mx-auto py-10 px-4">
          <div className="flex items-center mb-8">
            <Link
              href="/account"
              className="inline-flex items-center text-sm text-gray-600 hover:text-red-600 mr-6 font-medium transition-colors"
            >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Input
                        ...
                        required
                        className="h-12 px-4 pr-12 border-2 border-gray-200 rounded-xl focus:border-red-500 transition-colors"
